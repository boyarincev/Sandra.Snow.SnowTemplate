---
layout: post
title: ASP.NET 5: Новый тип проекта ASP.NET 5 и Учимся работать с Grunt
categories: ASP-NET-5, Grunt
published: draft
---

В этом посте я немного опишу новый проект веб-приложения ASP.NET 5, а также расскажу о настройке Grunt на минификацию и объединение javascript файлов автоматически.
...
После того, как студия закончит генерацию шаблона, вы получите пустой ASP.NET 5 проект готовый к работе.
...
Вероятно раньше для объединения и минификации javascript вы использовали механизм бандлов из ASP.NET MVC или функции расширения [WebEssentials](http://vswebessentials.com/), но теперь, с нативной поддержкой Grunt, мы можем всю подготовку frontend делать с помощью него.
